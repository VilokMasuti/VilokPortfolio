  ...
  return (
    ...
    >
      <Button
        ...
        size="icon"
        className={cn(
          "size-10 cursor-pointer p-0 transition-all duration-00 ease-in-out active:scale-95 btn-inner-shadow    shadow-[0px_1px_2px_0px_rgba(255,255,255,0.1)_inset,0px_-1px_2px_0px_rgba(255,255,255,0.1)_inset]",
          className
        )}
        onClick={toggleTheme}
